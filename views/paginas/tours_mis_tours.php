...
<main class="contenido-principal">
    <div class="container">
        ...
        <p class="hint">Aquí podés ver tus tours registrados y administrarlos.</p>

        <!-- Botón de exportación -->
        <div style="margin: 10px 0;">
            <a href="controllers/exportar.controlador.php?tipo=tours" class="btn secondary">
                Exportar a Excel
            </a>
                    ...
                    <td>
                        <?php if (!empty($t['imagen_principal'])): ?>
                            <img src="assets/images/<?= htmlspecialchars($t['imagen_principal']) ?>" 
                                alt="<?= htmlspecialchars($t['nombre_tour']) ?>" style="width:100px; height:auto;">
                        <?php else: ?>
