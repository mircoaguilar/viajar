...
if ($estadoProveedor && $estadoProveedor['estado'] !== 'aprobado') {
    $_SESSION['proveedor_pendiente'] = true;
} else {
    unset($_SESSION['proveedor_pendiente']);
}
...
<body>
    <main class="contenido-principal">
        <div class="container">
            ...
            <p>Hola <?= htmlspecialchars($_SESSION['usuarios_nombre_usuario'] ?? '') ?>, acá podés ver y editar tu información como proveedor.</p>

            <?php if (!empty($_SESSION['proveedor_pendiente'])): ?>
                <div class="bloqueo-pendiente">
                    <div class="mensaje-box">
                        <h2>Tu cuenta está en revisión</h2>
                        <p>Aún no podés acceder a las funciones de proveedor.</p>
                        <p>Un administrador revisará y aprobará tu solicitud pronto.</p>
                    </div>
                </div>
